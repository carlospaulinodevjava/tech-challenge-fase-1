...
public class CriarProprietarioStrategy implements CriarUsuarioStrategy {
    ...
    public CriarProprietarioStrategy(UsuarioRepository repository, UsuarioMapper mapper, PasswordEncoder encoder) {
    ...
    public UsuarioResponseDTO criar(UsuarioDTO dto) {
        // Lógica específica para PROPRIETÁRIO
